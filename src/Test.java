...
public class Test extends Game {
	...
	//	sprite.interpolateSkewX2(10f, 2000, false).delay(2000).repeatYoyo(Tween.INFINITY, 4000).start(sprite.tweenManager);
	//	sprite.interpolateSkewX3(10f, 2000, false).delay(2000).repeatYoyo(Tween.INFINITY, 4000).start(sprite.tweenManager);
	//	sprite.interpolateSkewX2(10f, 2000, false).delay(2000).repeat(Tween.INFINITY, 4000).start(sprite.tweenManager);
